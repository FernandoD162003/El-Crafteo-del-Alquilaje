public class Gestion {
	...
	public double comprarProducto(Producto[] productos, int num,
		...
		if (productos[num - 1].isDisponible()) {
			if (productos[num - 1].getCantStock() >= cantidadUnidades) {
				System.out.println("El alquilado se ha realizado con exito!!\n");
	...
	public double devolverProducto(Producto[] productos, int num,
			int cantidadUnidades) {
		if (productos[num - 1].isDisponible()) {
			if (productos[num - 1].getCantStock() >= cantidadUnidades) {
				...
				System.out.println("El stock de juegos ya esta lleno");
			}
		} else {
			System.out.println("El stock de juegos ya esta lleno");
		}
